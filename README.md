...
Built with **C# .NET 8 (Windows Forms)** and currently running in **In-Memory mode** (no database required for testing).

---

## 🚀 Features

- **Multi-role Support**: Student, Society Head, and Admin
